    ...
    <div className="hire-dev-car">
      <div className="home-card  ">
        ...
        <div className="card-desc max-w-sm p-5 bg-[#001035] overflow-hidden rounded-[10px] border-[#012b89] border-[1.5px]">
          <a href="dffklfkd">
            <h5 className="mt-9 mb-2 text-md font-medium tracking-wide text-white dark:text-white">{data.title}</h5>
          </a>
          <p className="mb-4 text-xs tracking-wider font-normal max-w-xs text-white dark:text-gray-400">{data.description}</p>
          <a
            href="sdsfsdkf"
